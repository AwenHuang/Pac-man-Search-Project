  ...
  while not statesQueue.isEmpty():
    ...
    for succ in successors:
      ...
      if not coor in visited:
        ...
        totalCost = problem.getCostOfActions(Path) + heuristicCost
        statesQueue.push((coor, Path), totalCost)        
  return []     
  #util.raiseNotDefined()
